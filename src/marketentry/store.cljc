(ns marketentry.store
  "SSoT for the Sierra Leone (SLE) market-entry compliance actor,
...
(defn demo-data
  ...
  `:claims-margin-of-preference?` / `:margin-of-preference-pct` /
  `:margin-of-preference-eligibility-ground` are ground truth for the
  `margin-of-preference-invalid-claim?` flagship check (Public
  Procurement Act 2016 Section 36 / Public Procurement Regulations
  2020 Regulation 75); `:requires-tax-clearance-record?` /
  `:tax-clearance-verified?` are ground truth for the conditional
  National Revenue Authority (NRA) tax-clearance check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Freetown Fabrication Ltd" :portal "nppa.gov.sl/vendor-registry"
             ...
             :requires-tax-clearance-record? true :tax-clearance-verified? true
             :drafted? false :submitted? false
             :jurisdiction "SLE" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "nppa.gov.sl/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-margin-of-preference? false
             :margin-of-preference-pct nil :margin-of-preference-eligibility-ground nil
    ...
    "eng-3" {:id "eng-3" :operator "Bo Systems Ltd" :portal "nppa.gov.sl/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "SLE" :status :intake}
    "eng-4" {:id "eng-4" :operator "Bunce Island Bottling Investments" :portal "nppa.gov.sl/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "SLE" :status :intake}
    "eng-5" {:id "eng-5" :operator "Makeni Logistics Ltd" :portal "nppa.gov.sl/vendor-registry"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :claims-margin-of-preference? false
             :margin-of-preference-pct nil :margin-of-preference-eligibility-ground nil
             :requires-tax-clearance-record? true :tax-clearance-verified? false
             :drafted? false :submitted? false
             :jurisdiction "SLE" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               claims-margin-of-preference? margin-of-preference-pct margin-of-preference-eligibility-ground
                               requires-tax-clearance-record? tax-clearance-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? claims-margin-of-preference?)  (assoc :engagement/claims-margin-of-preference? claims-margin-of-preference?)
    (some? margin-of-preference-pct)      (assoc :engagement/margin-of-preference-pct margin-of-preference-pct)
    margin-of-preference-eligibility-ground (assoc :engagement/margin-of-preference-eligibility-ground margin-of-preference-eligibility-ground)
    (some? requires-tax-clearance-record?) (assoc :engagement/requires-tax-clearance-record? requires-tax-clearance-record?)
    (some? tax-clearance-verified?)       (assoc :engagement/tax-clearance-verified? tax-clearance-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/claims-margin-of-preference? :engagement/margin-of-preference-pct
   :engagement/margin-of-preference-eligibility-ground
   :engagement/requires-tax-clearance-record? :engagement/tax-clearance-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :claims-margin-of-preference? (boolean (:engagement/claims-margin-of-preference? m))
     :margin-of-preference-pct (:engagement/margin-of-preference-pct m)
     :margin-of-preference-eligibility-ground (:engagement/margin-of-preference-eligibility-ground m)
     :requires-tax-clearance-record? (boolean (:engagement/requires-tax-clearance-record? m))
     :tax-clearance-verified? (boolean (:engagement/tax-clearance-verified? m))
